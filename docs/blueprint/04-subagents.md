...
└──────────────┬──────────────────────────────────────────────────────┘
    ...
    ▼                                              ▼ (conditional)
┌──────────┐  ┌──────────────────────┐  ┌────────────────────┐
│ DESIGN   │  │ MIGRATION ANALYST    │  │ PERFORMANCE ANALYST│
│ AGENT    │  │ Background           │  │ Background         │
│ [Tier 3] │  │ [Tier 3]             │  │ [Tier 3]           │
│ Explores │  │ Runs when migration  │  │ Runs when risk:high│
│ codebase │  │ file detected before │  │ + api layer present│
│ Proposes │  │ Gate 2               │  │ before Gate 2      │
│ plan     │  │ Returns safety report│  │ Returns perf report│
└──────────┘  └──────────────────────┘  └────────────────────┘

> **INIT mode**: no agent spawn. INIT scaffold executes via `bin/dev-flow-init.js` (per ADR-028 / Sprint 050). See `docs/blueprint/10a-init.md`.
