...
- **T7 close 2026-05-10** — README "How You Use It" helicopter view section added (per user mid-sprint addition · D-A scope expansion locked at promote b1ae530). Section inserted between "How to Adopt" and "First Sprint Walkthrough"; ~83 lines added (target ≤80 · 3-line overage accepted as soft-cap honor; user explicit call). Contains: 30-second pitch · 3-layer mental model ASCII (entry points → gates+modes → specialists+hooks) · top-level entry points table (9 rows: orchestrator init/sprint-bulk · prime · task-decomposer · lean-doc-generator · diagnose · refactor-advisor · release-patch · security-review) · end-to-end lifecycle ASCII (DAY 0 adopt → DAY 1 feature+promote → DAY 1-N execute → DAY N close) · 4-bullet "good behavior" rules. Section reflects POST-Sprint-059 state (15 skills · 6 agents · `--grill` flag available · Flow Grill loop). Banner/Roadmap/components-table edits intentionally NOT touched (T6 scope). README total 178 → 261 lines.
...
- `README.md` | T7 | EDIT (178 → 261 lines · +83 added) — new ## How You Use It section between How to Adopt and First Sprint Walkthrough; helicopter view: 30s pitch · 3-layer mental model · entry points table (9 rows) · end-to-end lifecycle ASCII · 4-bullet good-behavior rules; reflects post-Sprint-059 state (15 skills · 6 agents · --grill flag · Flow Grill); banner/Roadmap/components-table preserved for T6 | risk: low | test: N/A
