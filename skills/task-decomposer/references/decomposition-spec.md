...
<!-- TASK row format: see `templates/TODO.md.template` (canonical source per ADR-030).
     Required fields (8): scope · layers · api-change · acceptance · tracker · risk · depends-on · assumptions.
     Validation rules apply per §Validation Rules below.
     Template wins on divergence — if this stub diverges from templates/TODO.md.template, fix here. -->
- [ ] **TASK-[NNN]: [Title]** — [why it matters, one line]
  *(field schema: `templates/TODO.md.template` § TASK row · all 8 fields required)*
