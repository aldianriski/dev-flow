...
// Plugin mode: CLAUDE_PLUGIN_ROOT is set by CC when running inside a plugin install.
// Scaffold-copy mode: falls back to .claude/ prefix in the project root.
const PLUGIN_ROOT = process.env.CLAUDE_PLUGIN_ROOT;
const SKILLS_DIR    = PLUGIN_ROOT ? `${PLUGIN_ROOT}/skills` : '.claude/skills';
const MANIFEST_PATH = PLUGIN_ROOT ? `${PLUGIN_ROOT}/skills/MANIFEST.json` : '.claude/skills/MANIFEST.json';
